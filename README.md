...
## Документация
- [SPRINT-4-FINAL-REPORT](SPRINT-4-FINAL-REPORT.md) — итоговый отчёт по поисковому стеку.
- [SPRINT-5-PLAN](SPRINT-5-PLAN.md) — план следующего спринта (Интерактивная карта).
- [DEPLOYMENT-CHECKLIST](DEPLOYMENT-CHECKLIST.md) — чеклист продакшн-выкатки.
- [README-API](README-API.md) — API-гайд с примерами.
